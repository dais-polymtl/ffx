#ifndef VFENGINE_INDEX_NESTED_LOOP_JOIN_PACKED_GP_CASCADE_PREDICATED_SHARED_OPERATOR_HH
#define VFENGINE_INDEX_NESTED_LOOP_JOIN_PACKED_GP_CASCADE_PREDICATED_SHARED_OPERATOR_HH

#include "../../table/include/ffx_str_t.hpp"
#include "../factorized_ftree/ftree_state_update.hpp"
#include "../predicate/predicate_eval.hpp"
#include "inljoin_packed_gp_cascade_shared.hpp"// For VectorGPSavedData
...
template<typename T>
class INLJoinPackedGPCascadePredicatedShared final : public Operator {
public:
    INLJoinPackedGPCascadePredicatedShared() = delete;
    INLJoinPackedGPCascadePredicatedShared(const INLJoinPackedGPCascadePredicatedShared&) = delete;

    // Constructor with predicate expression
    INLJoinPackedGPCascadePredicatedShared(std::string join_key, std::string output_key, bool is_join_index_fwd,
...
using INLJoinPackedGPCascadePredicatedSharedUint64 = INLJoinPackedGPCascadePredicatedShared<uint64_t>;
using INLJoinPackedGPCascadePredicatedSharedString = INLJoinPackedGPCascadePredicatedShared<ffx_str_t>;
