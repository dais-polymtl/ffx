...
public:
    ...
    static std::string ConstructInputTuplesColumnEncoded(const nlohmann::json& columns);
    static std::string ConstructInputTuplesCompactRepFormat(const nlohmann::json& columns);
